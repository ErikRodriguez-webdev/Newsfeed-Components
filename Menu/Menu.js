...
function createMenu(menuArray) {
  ...
  menuArray.forEach(function(links) {
    let theMenuItems = document.createElement("li");
    theMenuItems.textContent = links;
    menuList.append(theMenuItems);
  });

  menuBox.classList = "menu";
